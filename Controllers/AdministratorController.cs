...
namespace OurProject.Controllers
{
    ...
    public class AdministratorController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError("", "Can not remove calims for this user");
                return View(model);
            }
        ...
        public async Task<IActionResult> ManageUsersRoles(List<UserRolesViewModel> model, string userId)
        {
            var user = await userManager.FindByIdAsync(userId);
            if (user == null)
            {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError("", "Cannot complete this action");
                return View(model);
            }
